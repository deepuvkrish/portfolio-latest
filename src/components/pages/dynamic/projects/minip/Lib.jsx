...
import { projectFeaturesLibrary } from "../../../constants";
import { login, books, student, records, checklist } from '../../../assets'
        ...
        <div className="project-page-overlay" style={{ backgroundImage: `url(${m.primg})` }}>
            ...
            <div className="project-view">
                ...
                <div className="project-view-features">
                    <h3>Features</h3>
                    <ul>
                        {projectFeaturesLibrary.map((f) => <Showfeatures feature={f.feature} />)}
                    </ul>
                    <ul className="animation-ul">
                        <li><DisplayLottie lottiename={login} /></li>
                        <li><DisplayLottie lottiename={books} /></li>
                        <li><DisplayLottie lottiename={student} /></li>
                        <li><DisplayLottie lottiename={checklist} /></li>
